...
class ForRentService {

    
    func fetchForRentMovies(completion: @escaping (Result<[Movie], Error>) -> Void) {
        let urlString = "https://api.themoviedb.org/3/trending/all/week?language=en-US&api_key=909594533c98883408adef5d56143539"
...
//
    ...
    func fetchForRentVideos(for movieID: Int, completion: @escaping (Result<[Video], Error>) -> Void) {
