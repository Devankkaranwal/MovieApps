...
//
    ...
    func fetchStreamingMovies(completion: @escaping (Result<[Movie], Error>) -> Void) {
        let urlString = "https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=false&language=en-US&page=7&sort_by=popularity.desc&api_key=909594533c98883408adef5d56143539"
    ...
    func fetchStreamingVideos(for movieID: Int, completion: @escaping (Result<[Video], Error>) -> Void) {
